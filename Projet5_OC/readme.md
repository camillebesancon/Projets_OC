...
- Lien de téléchargement : https://www.kaggle.com/olistbr/brazilian-ecommerce
...
1. un notebook avec des essais des différentes approches de modélisation
2. un notebook de simulation pour déterminer la fréquence nécessaire de mise à jour du modèle de segmentation, afin que celui-ci reste pertinent
3. une présentation pour un collègue afin d’obtenir ses retours sur votre approche.
